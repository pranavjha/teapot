...
Class.use("teapot.screen.Builder");
/**
 * Defines the class for the builder screen
 */
teapot.screen.Builder = teapot.base.UiElement.extend(
/*
 * public declarations
 */
{
 ...
 */
{
     ...
     * @private
     */
    styleNamespace : "styles.teapot.screen.Builder",

    /**
     * @type {string} the template namespace
     * @private
     */
    templateNamespace : "templates.teapot.screen.Builder",

    /**
     * the logger utility object
     */
    LOG : teapot.util.Logger.getLogger('teapot.screen.Builder')
});